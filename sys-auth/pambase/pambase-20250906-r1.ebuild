...
LICENSE="MIT"
SLOT="0"
IUSE="caps debug elogind gnome-keyring homed minimal mktemp +nullok pam_krb5 pam_ssh +passwdqc pwhistory pwquality securetty selinux +sha512 sssd systemd turnstile yescrypt"

RESTRICT="binchecks"

REQUIRED_USE="
	?? ( elogind systemd turnstile )
	?? ( passwdqc pwquality )
	?? ( sha512 yescrypt )
